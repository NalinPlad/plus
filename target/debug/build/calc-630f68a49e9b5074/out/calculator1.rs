...
// sha3: ad783f67195ae7f16f86f2797a1c7098b8f1a820c8edf30a8e86f09a5444abbc
use std::str::FromStr;
...
mod __parse__Expr {
    ...
    impl ExprParser {
        ...
        >(
            &self,
            input: &'input str,
        ) -> Result<f32, __lalrpop_util::ParseError<usize, Token<'input>, &'static str>>
        {
    ...
    >(
        ...
        _: core::marker::PhantomData<(&'input ())>,
    ) -> Option<Result<f32,__lalrpop_util::ParseError<usize, Token<'input>, &'static str>>>
    {
